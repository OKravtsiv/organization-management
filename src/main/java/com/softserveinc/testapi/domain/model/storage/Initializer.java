...
public class Initializer {
    ...
    public void fillData() {
        User user1 = new User("Ostap", "Kravtsiv", "OKravtsiv", "lil", UserRights.ADMIN);
        User user2 = new User("Andriy", "Kimachuk", "AKimachuk", "lol", UserRights.MANAGER);
        User user3 = new User("Khrystyna", "Koblents", "KKoblents", "lel", UserRights.MANAGER);
        User user4 = new User("Uliana","Pizhanska", "UPizhanska", "lul", UserRights.MANAGER);
